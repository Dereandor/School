...
let pool = mysql.createPool({
  ...
  user: 'torstehs', // Replace "username" with your mysql-ait.stud.idi.ntnu.no username
  password: 'Pzp58gsc', // Replae "password" with your mysql-ait.stud.idi.ntnu.no password
  database: 'torstehs' // Replace "username" with your mysql-ait.stud.idi.ntnu.no username
});
