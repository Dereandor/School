...
/**
 * KLASSEN STUDENT. Et studentobjekt er et personobjekt med tilleggsinformasjon
 * om studentnummer og alle fagene studenten har tatt eller skal ta. Listen med
 * fag kan utvides. Det er videre mulig å registrere og hente ut karakteren i et
 * bestemt fag.
 */
class Student extends Person {
	...
	/**
	 * Metoden tar fagnummer som argument. Den registrerer nytt fag med dette
	 * nummeret, dersom det ikke er registrert fra før. Metoden returnerer en
	 * referanse til fagobjektet, uansett om det er nytt eller ikke.
	 */
	...
	/**
	 * Metoden registrerer karakter i et bestemt fag. Det er ingen kontroll av at
	 * karakteren er gyldig. Hvis fag med den oppgitte koden ikke er registrert fra
	 * før, så blir det registrert.
	 */
	...
	/**
	 * Metoden leter opp fag med det oppgitte nummer. Returnerer null hvis fag ikke
	 * finnes.
	 */
