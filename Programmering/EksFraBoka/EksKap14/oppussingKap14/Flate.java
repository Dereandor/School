...
class Flate {
  ...
  private Materiale materialtype;
  ...
  public void setMaterialtype(Materiale nyMaterialtype) {
    materialtype = nyMaterialtype;
  }

  public Materiale getMaterialtype() {
    return materialtype;
  }
  ...
  public String toString() {
    ...
    if (materialtype != null) {
      f.format(", dekkes med " + materialtype.getNavn());
    } else {
      f.format(" Materialtype ikke registrert. ");
    }
    return f.toString();
  }
