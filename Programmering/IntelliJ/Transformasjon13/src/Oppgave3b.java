...
public class Oppgave3b  extends GLCanvas implements GLEventListener {
    
    private static String TITLE = "Oppgave3b";
...
// ------ Implement methods declared in GLEventListener (init,reshape,display,dispose)
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glRotatef(45, 0.5f,0.0f,0.5f);
