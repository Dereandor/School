/*
 * TestArrays.java   E.L. 2002-07-22
 *
...
class TestArrays {
  public static void main(String[] args) {
    ...
    nyTabell[pos] = 14;
    for (int i = pos + 1; i < nyTabell.length; i++) nyTabell[i] = test[i - 1];
